...
variable "third_storage_account_name" {
  description = "A globally unique name for the third Azure Storage Account (must be 3-24 characters, lowercase letters and numbers only)."
  type        = string
}

variable "third_storage_account_tier" {
  description = "The pricing tier for the third Storage Account (e.g., Standard, Premium)."
  type        = string
  default     = "Standard"
}

variable "third_storage_account_replication_type" {
  description = "The replication strategy for the third Storage Account (e.g., LRS, GRS, ZRS, RAGRS, GZRS, RAZRS)."
  type        = string
  default     = "GRS"
}

variable "third_storage_account_kind" {
  description = "The kind of Storage Account to create (e.g., StorageV2, BlobStorage, BlockBlobStorage, FileStorage)."
  type        = string
  default     = "StorageV2"
}
