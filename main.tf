...
resource "azurerm_storage_account" "third" {
  name                     = var.third_storage_account_name
  resource_group_name      = azurerm_resource_group.kv_rg.name
  location                 = azurerm_resource_group.kv_rg.location
  account_tier             = var.third_storage_account_tier
  account_replication_type = var.third_storage_account_replication_type
  account_kind             = var.third_storage_account_kind
